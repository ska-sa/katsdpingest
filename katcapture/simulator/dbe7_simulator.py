...
class SimulatorDeviceServer(DeviceServer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._my_sensors[msens.name] = msens
        self.c = K7Correlator(kwargs['config_file'])
        self._my_sensors["destination_ip"].set_value(self.c.config['rx_meta_ip'])
    ...
    def setup_sensors(self):
        for sensor in self._my_sensors:
            activitylogger.info('Adding sensor %s.' % sensor)
